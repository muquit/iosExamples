...
* Read data from [SQLite](http://www.sqlite.org/) with ease using [FMDB](https://github.com/ccgus/fmdb). [CountriesDatabase.m](/iosExamples/WorldFactsSQLite/WorldFactsSQLite/CountriesDatabase.m)
